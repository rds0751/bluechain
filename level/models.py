...
class PoolUser(models.Model):
    ...
    upline = models.CharField(max_length=10, null=True, blank=True)
    d1 = models.CharField(max_length=10, default='', null=True, blank=True)
    d2 = models.CharField(max_length=10, default='', null=True, blank=True)
    d3 = models.CharField(max_length=10, default='', null=True, blank=True)
    created_at = models.DateTimeField(default=timezone.now, blank=True)
    updated_at = models.DateTimeField(auto_now=True, blank=True)
