...
admin.site.site_header = "BluechainDefi Admin"
admin.site.index_title = "Welcome to BluechainDefi"
admin.site.site_title = "BluechainDefi"
...
urlpatterns = [
    ...
    path('plan/', RedirectView.as_view(url=staticfiles_storage.url("BluechainDefiplan.pdf")),)
]
if settings.DEBUG:
